...
romulus_base_path = '/data/REPOSITORY/e11Gals/romulus_dwarf_zooms/'
...
Sims = {
    ...
    'r431' : {
        'path' : romulus_base_path + 'r431.romulus25.3072g1HsbBH/r431.romulus25.3072g1HsbBH.004096/r431.romulus25.3072g1HsbBH.004096',
        # Update the 'halos' and 'goodhalos' values as per your data
        'halos' : [0,1], # later I should check if there are more halos to add. 
        'goodhalos' : [0,1]
    },
}
