...
StellarShape = pickle.load(open(f'../../Data/{args.simulation}.{args.feedback}.3DShapes.pickle','rb'))
...
pickle.dump(ShapeFile,open(f'../../Data/{args.simulation}.{args.feedback}.DMShapes.pickle','wb'))
tstop = time.time()
